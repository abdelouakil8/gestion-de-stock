...
STOCK_RECEIVE_BUTTON = "استلام"
STOCK_RECEIVE_PROMPT = "الكمية المراد إضافتها لـ {name}:"
STOCK_RECEIVE_TOAST = "تمت إضافة {qty} وحدة إلى {name}."
LABEL_SENT_TOAST = "تم إرسال الملصق إلى الطابعة."
EXPORT_WRITE_ERROR = "خطأ في الكتابة: {error}"
