...
FEATURE_TOUR_WELCOME_DESC = "لنقم بجولة سريعة وتفاعلية في التطبيق. سنتنقل بين الشاشات معًا."
FEATURE_TOUR_NAV_CAISSE_DESC = "شاشة البيع. من هنا تمسح الباركود وتضيف إلى السلة وتُحصّل يوميًا."
FEATURE_TOUR_SEARCH_TITLE = "إضافة المنتجات"
FEATURE_TOUR_SEARCH_DESC = "امسح الباركود أو اكتب الاسم، ثم اضغط Entrée لإضافة الصنف إلى السلة."
FEATURE_TOUR_PAY_TITLE = "التحصيل (F12)"
FEATURE_TOUR_PAY_DESC = "أنهِ البيع: دفع كامل، أو جزئي (دَيْن) مرتبط بعميل. المفتاح F12 يفتح نافذة التحصيل."
...
FEATURE_TOUR_SETTINGS_DESC = "خصّص الإيصال والطابعة واللغة ولون التمييز، واحفظ نسخة من بياناتك."
FEATURE_TOUR_DONE_TITLE = "أنت جاهز!"
FEATURE_TOUR_DONE_DESC = "هذا كل شيء! يمكنك إعادة تشغيل الجولة في أي وقت من الإعدادات. بيعًا موفقًا."
