...
UPDATE_CHECK_URL = "https://api.github.com/repos/abdelouakil8/gestion-de-stock/releases/latest"
...
def check_for_update(current_version: str = CURRENT_VERSION) -> Optional[UpdateInfo]:
